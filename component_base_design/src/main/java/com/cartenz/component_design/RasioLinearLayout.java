...
public class RasioLinearLayout extends LinearLayout {
    ...
    public RasioLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle);
    }

    public RasioLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, DEFAULT);
    }

    public RasioLinearLayout(Context context) {
        super(context);
